package com.cihangir.dynamic_programming._04_candies;
...
public class Candies0App {
  ...
  public static void main(String[] args) throws IOException {
    final String inputPath = getPath("input2");
  ...
  static String getPath(String fileName) {
    ...
    return currentDirectory
        + "/src/main/java/com/cihangir/dynamic_programming/_04_candies/testdata/" + fileName
        + ".txt";
  }
