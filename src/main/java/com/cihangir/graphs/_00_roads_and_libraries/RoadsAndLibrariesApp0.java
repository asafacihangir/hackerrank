package com.cihangir.graphs._00_roads_and_libraries;
...
public class RoadsAndLibrariesApp0 {
  ...
  static void run() throws IOException {
    ...
    final String inputPath = currentDirectory + "/src/main/java/com/cihangir/graphs/_00_roads_and_libraries/testdata/input2.txt";
